  ...
  <div style="max-width:640px;margin:24px auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.12)">
    ...
    <div style="padding:20px 32px;border-bottom:1px solid #eee">
      ...
      <table style="border-collapse:collapse;width:100%;font-size:14px;font-family:Arial,sans-serif;">
       ...
       <tr>
  <td style="padding:4px 0;color:#888;font-family:Arial,sans-serif;">Địa chỉ:</td>
    ...
    ${(() => {
      ...
      return `
        ...
        <a href="https://www.google.com/maps?q=${lat},${lon}" 
           target="_blank" 
           style="color:#1a73e8;font-size:13px;text-decoration:none;font-weight:bold;display:inline-block;margin-top:4px;">
           <i class="fa-solid fa-map-location-dot" style="margin-right:4px;color:#ea4335;"></i> Xem trên Google Maps
        </a>
      `;
    })()}
  </td>
...
async function sendOrderNotification(order) {
  try {
    ...
    const ICONS = {
      ...
      'măng': '<i class="fa-solid fa-screwdriver-wrench text-slate-500"></i>', 'đá cắt': '<i class="fa-solid fa-compact
